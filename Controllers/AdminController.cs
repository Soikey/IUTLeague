...
namespace IUTLeague.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PhoneNumber,Password")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PhoneNumber,Password")] Admin admin)
        {
            if (id != admin.Id)
            {
                return NotFound();
